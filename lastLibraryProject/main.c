...
char query[20], name[20], Admin_Name[60], A_user_Name[60], Admin_pass[60];
FILE *fp, *ft, *msg, *admin_name, *save_admin_name, *save_admin_pass;
int i, n, ch, l, found;
...
void addbk()
{
    ...
    printf("\t\t\t\t====================================================\n");
    printf("\t\t\t\t=====================================[ Add Books ]==\n");
    printf("\t\t\t\t=======[ Press enter to go back on catagory ]=======\n");
    printf("\t\t\t\t====================================================\n");
    printf("\n");
    fp=fopen("contact.dll","a");//dll=Dynamic Link Library(for holding multiple codes and procedures for Windows programs.)
    for (;;)
    {
        fflush(stdin);
        printf("\t\t\t\tEnter Catagory: ");
        scanf("%[^\n]",&library.catagory);
        if(strcmp(library.catagory," ")==0)subadmin();
        fflush(stdin);
        printf("\t\t\t\t");
        printf("  Book Self No: ");
        scanf("%[^\n]",&library.bself);
...
up:
    ...
    printf("\t\t\t\t|+   6. Md Mostafizur Rahman  [ID: 181-15-2013]   +|\n");
    printf("\t\t\t\t|+                                                +|\n");
    printf("\t\t\t\t|+                                                +|\n");
    printf("\t\t\t\t|+    Purpose of this application is to find      +|\n");
    printf("\t\t\t\t|+    Books easily from a library.                +|\n");
    printf("\t\t\t\t|+                                                +|\n");
...
div:
    ...
    for(;;)
    {
        ...
        case 0:
        {
            ...
            for(i=0; i<70; i++)
            {
                if(i==0)system("color 01");
                if(i==3)system("color 02");
                if(i==6)system("color 03");
                if(i==9)system("color 04");
                if(i==12)system("color 05");
                if(i==15)system("color 06");
                if(i==18)system("color 07");
                if(i==21)system("color 08");
                if(i==24)system("color 0A");
                if(i==27)system("color 0B");
                if(i==30)system("color 0C");
                if(i==33)system("color 0D");
                if(i==36)system("color 0E");
                if(i==39)system("color 0F");
                if(i==42)system("color 02");
                if(i==45)system("color 04");
                if(i==48)system("color 06");
                if(i==51)system("color 08");
                if(i==54)system("color 0A");
                if(i==57)system("color 0C");
                if(i==60)system("color 0E");
                if(i==63)system("color 01");
                if(i==66)system("color 07");
                if(i==69)system("color 0B");
                printf("#");
                for(j=0; j<9999999; j++);
            }
            printf("]");
