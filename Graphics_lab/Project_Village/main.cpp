...
void building()
{
    ...
    glBegin(GL_QUADS); //ground floor window
    ...
    glVertex2f(-0.665f,-0.14f);
    glEnd();

    glBegin(GL_QUADS);//4th floor door
    glColor3ub(0,0,0);
    glVertex2f(-0.865f,0.12f);
    glVertex2f(-0.83f,0.12f);
    glVertex2f(-0.83f,0.03f);
    glVertex2f(-0.865f,0.03f);
    glEnd();

    glBegin(GL_QUADS);//4th floor door
    glColor3ub(0,0,0);
    glVertex2f(-0.665f,0.12f);
    ...
    glColor3ub(0,0,0);
    glVertex2f(-0.865f,0.295f);
    glVertex2f(-0.83f,0.295f);
    glVertex2f(-0.83f,0.205f);
